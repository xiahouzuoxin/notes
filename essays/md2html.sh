...
echo "转载请注明出处: <a href=\"http://xiahouzuoxin.github.io/notes/\">http://xiahouzuoxin.github.io/notes/</a>" >> temp_title.html
...
pandoc $1 --include-in-header temp_head_keywords.html --include-before-body header.html --include-before-body temp_title.html --toc --include-after-body comments.html --include-after-body footer.html -o ../html/${1%.*}".html" -c ../stylesheets/Github.css
echo "$1"
